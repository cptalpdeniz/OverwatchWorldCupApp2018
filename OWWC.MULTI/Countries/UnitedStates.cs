namespace OWWC.MULTI.Countries
{
    ...
    {
        public static int ID { get; set; } = 24;
        public static string nameOfCountry { get; set; } = "United States";
        public static bool passedGroupStage { get; set; } = false;
        public static string abbreviation { get; set; } = "US";
        public static string flagLocation { get; set; } = "usFlag.png";
