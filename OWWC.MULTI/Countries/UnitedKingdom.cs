namespace OWWC.MULTI.Countries
{
    ...
    {
        public static int ID { get; set; } = 23;
        public static string nameOfCountry { get; set; } = "United Kingdom";
        public static bool passedGroupStage { get; set; } = false;
        public static string abbreviation { get; set; } = "UK";
        public static string flagLocation { get; set; } = "ukFlag.png";
