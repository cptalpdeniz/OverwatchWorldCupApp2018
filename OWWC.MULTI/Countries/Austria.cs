namespace OWWC.MULTI.Countries
{
	...
	public static int ID { get; set; } = 2;
        public static string nameOfCountry { get; set; } = "Austria";
        public static bool passedGroupStage { get; set; } = false;
        public static string abbreviation { get; set; } = "AT";
        public static string flagLocation { get; set; } = "austriaFlag.png";
